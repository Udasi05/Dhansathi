...
```
mad-mini/
├── myminiproject/                     # 📱 Android App (Kotlin)
│   ├── app/
│   │   ├── src/main/
│   │   │   ├── AndroidManifest.xml
│   │   │   ├── java/com/example/myminiproject/
│   │   │   │   ├── DhanSathiApplication.kt          # Application class
...
│   │   │   │   │   │   ├── SchemesScreen.kt          # Govt schemes
│   │   │   │   │   │   ├── TrackMoneyScreen.kt       # Cash diary
│   │   │   │   │   │   ├── LearnScreen.kt            # Learning center
│   │   │   │   │   │   ├── ProfileScreen.kt          # User profile
│   │   │   │   │   │   ├── EditProfileScreen.kt      # Edit profile
│   │   │   │   │   │   ├── ChatBotScreen.kt          # AI Saathi chatbot
│   │   │   │   │   │   ├── VoiceInputScreen.kt       # Voice interactions
│   │   │   │   │   │   ├── AnalyticsScreen.kt        # Financial analytics
│   │   │   │   │   │   ├── HelpSupportScreen.kt      # Help & support
│   │   │   │   │   │   ├── MyTicketsScreen.kt        # Support tickets
...
│   │   │   │   │       ├── SchemesViewModel.kt       # Schemes state
│   │   │   │   │       ├── TransactionViewModel.kt   # Transactions
│   │   │   │   │       ├── ChatBotViewModel.kt       # Chat state
│   │   │   │   │       ├── VoiceInputViewModel.kt    # Voice state
│   │   │   │   │       ├── AnalyticsViewModel.kt     # Analytics state
│   │   │   │   │       └── TicketViewModel.kt        # Tickets state
│   │   │   │   ├── data/
│   │   │   │   │   ├── api/
...
│   └── gradle/
│
└── server/                            # 🖥️ FastAPI Backend (Python)
    ├── main.py                        # All API endpoints (~1575 lines)
    ├── requirements.txt               # Python dependencies
    ├── Procfile                       # Deployment config (Heroku/Render)
    ├── .env                           # Environment variables
    ├── firebase-key.json              # Firebase Admin SDK key
    └── data/
        ├── crop_data.csv              # 10 Maharashtra crop records
        ├── schemes.json               # 7 government schemes
        ├── schemes_marathi.json       # Marathi translations
        ├── user_income_data.json      # Sample income data
        └── navigation_kb.json         # Navigation knowledge base
```
...
The app includes **17 screens** organized across the user journey:

| # | Screen | Description |
|---|--------|-------------|
| 1 | **Splash Screen** | Animated brand splash with DhanSathi logo |
| 2 | **Login Screen** | Phone number-based authentication |
| 3 | **Sign Up Screen** | New user registration |
| 4 | **OTP Screen** | Firebase OTP verification |
| 5 | **Dashboard** | Central hub with income summary, quick actions, and farm status |
| 6 | **Schemes** | Browse & check eligibility for 7+ government schemes |
| 7 | **Track Money (Cash Diary)** | Log income/expenses with voice or manual entry |
| 8 | **Learn** | Educational farming content and tutorials |
| 9 | **Profile** | View user details, land info, and settings |
| 10 | **Edit Profile** | Update personal and farming information |
| 11 | **Voice Input** | Hands-free voice interaction |
| 12 | **AI Saathi (Chatbot)** | Bilingual AI farming advisor |
| 13 | **Help & Support** | Get help and raise issues |
| 14 | **My Tickets** | Track support ticket status |
| 15 | **Analytics** | Visual financial charts and breakdowns |
| 16 | **Data Export** | Export records for offline use |
| 17 | **Notification Preferences** | Configure push notification settings |
